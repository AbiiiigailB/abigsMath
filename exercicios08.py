...
#  6. Faça uma função que recebe um nome e um horário e imprime “Bom dia, [nome]”, 
# caso seja antes de 12h; “Boa Tarde, [nome]”, caso seja entre 12h e 18h; e “Boa noite, [nome]” caso seja após às 18h.
...
#  8. Escreva uma função para validar uma variável string. 
# Essa função recebe como parâmetro a string, os números mínimo e máximo de caracteres. Retorne verdadeiro,
# se o tamanho da string estiver entre os valores de máximo e mínimo, e falso em caso contrário.
...
#  9. Escreva uma função que receba uma string e uma lista. 
# A função deve comparar a string passada com os elementos da lista, 
# também passada como parâmetro. Retorne verdadeiro, se a string for encontrada dentro da lista, e falso, em caso contrário.
